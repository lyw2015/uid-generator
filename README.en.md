...
Quick Start
------------
Here we have a demo with 4 steps to introduce how to integrate UidGenerator.<br/>
...
Reset property of 'spring.datasource.url', 'spring.datasource.username' and 'spring.datasource.password' in [application.yaml](src/main/resources/application.yaml).

### Step 3: Spring configuration
There are two implements of UidGenerator: [DefaultUidGenerator](src/main/java/com/baidu/fsg/uid/core/impl/DefaultUidGenerator.java)、[CachedUidGenerator](src/main/java/com/baidu/fsg/uid/core/impl/CachedUidGenerator.java).
For performance sensitive application, CachedUidGenerator is recommended.  

Reset property of 'uid-generator.*' in [application.yaml](src/main/resources/application.yaml).
